...
def run(curTetta, goalTetta):
	...
	dataOutput = open("7LabMeasurementsDKP [" + str(round(curCords[0])) + " " + str(round(curCords[1])) + " " + str(round(curCords[2])) + "] -> [" + str(goalCords[0]) + " " + str(goalCords[1]) + " " + str(goalCords[1]) + "].txt","w+")
