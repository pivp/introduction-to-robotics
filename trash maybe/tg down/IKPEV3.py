...
def run(curCords, goalCords, curTetta):
	...
	dataOutput = open("7LabMeasurementsIKP [" + str(round(curCords[0])) + " " + str(round(curCords[1])) + " " + str(round(curCords[2])) + "] -> [" + str(goalCords[0]) + " " + str(goalCords[1]) + " " + str(goalCords[1]) + "].txt","w+")
...
run([-0.03, 0, 0.433], [0.23, 0, 0.173], [0, 0, 0])